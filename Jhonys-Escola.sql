...
CREATE TABLE `curso` (
  ...
  KEY `cod_camp` (`cod_camp`),
  CONSTRAINT `curso_ibfk_1` FOREIGN KEY (`cod_camp`) REFERENCES `campus` (`cod_campus`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `curso` VALUES (1,1,'Engenharia Civil','Diurno',10,1500.00),(2,2,'Administração de Empresas','Noturno',8,1200.00),(3,3,'Medicina','Integral',12,2000.00),(4,1,'Ciência da Computação','Diurno',8,1400.00),(5,2,'Direito','Matutino',10,2000.00),(6,2,'Psicologia','Vespertino',9,1100.00),(7,1,'Arquitetura e Urbanismo','Integral',11,1450.00),(8,1,'Engenharia Elétrica','Diurno',10,1400.00),(9,3,'Pedagogia','Noturno',8,1000.00),(10,3,'Nutrição','Matutino',9,1300.00),(11,3,'Fisioterapia','Vespertino',9,1250.00),(12,3,'Odontologia','Integral',11,1450.00),(13,1,'Engenharia Mecânica','Diurno',10,1350.00),(14,1,'Ciências Contábeis','Noturno',8,1100.00),(15,2,'Comunicação Social - Jornalismo','Matutino',8,1000.00),(16,2,'Artes Visuais','Diurno',5,1000.00),(17,2,'Design Gráfico','Matutino',6,1300.00),(18,2,'Jogos Digitais','Noturno',8,1400.00),(19,2,'Multimídia','Noturno',4,1800.00);
...
CREATE TABLE `matricula` (
  ...
  `ra_alunos` int(11) DEFAULT NULL,
  `cod_cursos` int(11) DEFAULT NULL,
  PRIMARY KEY (`cod_matricula`),
  KEY `ra_alunos` (`ra_alunos`),
  KEY `cod_cursos` (`cod_cursos`),
  CONSTRAINT `matricula_ibfk_1` FOREIGN KEY (`ra_alunos`) REFERENCES `aluno` (`ra_aluno`),
  CONSTRAINT `matricula_ibfk_2` FOREIGN KEY (`cod_cursos`) REFERENCES `curso` (`cod_curso`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-04-22 21:40:46
